...
//╚════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╝
        public Cell(int2 coords, NativeArray<float3> cellVertices)
        {
            ...
            Vertices.Add(cellVertices[0]);
            Vertices.Add(cellVertices[1]);
            Vertices.Add(cellVertices[2]);
            Vertices.Add(cellVertices[3]);
...
//╚════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╝
        ...
        public readonly float3 Center => Vertices[1] + (Vertices[2] - Vertices[1]) / 2;
        ...
        public bool Contains(float2 position2D)
        {
        ...
        public float3 GetPosition(float2 position2D)
        {
            ...
            float t = dot(Vertices[isLeftTri ? 0 : 1] - rayOrigin, triangleNormal) / dot(down(), triangleNormal);

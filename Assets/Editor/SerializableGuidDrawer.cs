...
namespace Kaizerwald
{
    ...
    public class SerializableGuidDrawer : PropertyDrawer 
    {
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) 
        {
            ...
            SerializedProperty value0 = property.FindPropertyRelative("Part1");
            SerializedProperty value1 = property.FindPropertyRelative("Part2");
            SerializedProperty value2 = property.FindPropertyRelative("Part3");
            SerializedProperty value3 = property.FindPropertyRelative("Part4");
